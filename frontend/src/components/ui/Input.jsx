const shellClasses =
  'w-full rounded-lg border border-slate-200 bg-white px-3.5 py-2.5 text-sm text-slate-900 outline-none transition duration-150 ease-out focus:border-sky-500 focus:ring-2 focus:ring-sky-100'
